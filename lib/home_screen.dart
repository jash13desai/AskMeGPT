...
import 'package:askme/chat_box.dart';
import 'package:askme/openai_services.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: ZoomIn(
        ...
        child: FloatingActionButton.extended(
          ...
          label: speechToText.isNotListening
          ...
          onPressed: () async {
            if (await speechToText.hasPermission &&
              ...
              final speech = await openAIService.isArtPromptAPI(voiceInput);
              print(speech);
